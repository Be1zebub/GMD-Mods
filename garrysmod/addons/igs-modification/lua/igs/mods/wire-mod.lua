...
hook.Add("CanTool", "https://github.com/Be1zebub/GMD-Mods/blob/master/garrysmod/addons/igs-modification/lua/mods/wire-mod.lua", function(ply, _, toolname) -- запрещает использование инструмента
...
if CLIENT then
	...
	end, "https://github.com/Be1zebub/GMD-Mods/blob/master/garrysmod/addons/igs-modification/lua/mods/wire-mod.lua")
end
